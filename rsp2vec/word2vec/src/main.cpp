...
void printUsage() {
	std::cerr
		...
		<< "  substotune   ------ train chinses character embedding by use substoke and tone model\n"
		<< std::endl;
}
...
int main(int argc, char** argv){
	...
	if (command != "skipgram" && command != "cbow" && command != "subword" && command != "substoke" && command != "substotune") {
